...
void launchScreen() {
	...
	printLetter(font_E, sizeof(font_E)/sizeof(*font_E), size, 23, y_peta);
	printLetter(font_T, sizeof(font_T)/sizeof(*font_T), size, 38, y_peta);
	printLetterCounter(font_A_out, sizeof(font_A_out)/sizeof(*font_A_out), font_A_in, sizeof(font_A_in)/sizeof(*font_A_in), size, 55, y_peta);
}
